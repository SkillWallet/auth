    ...
    return (
      <div class="user-details-modal-window-child">
          ...
          <div class="field-content">
            ...
            <div class="avatar-div">
              ...
              <div class="field-wrapper-avatar">
                <div class="sw-uploader-wrapper" >
                  <div class="MuiAvatar-root MuiAvatar-circular MuiAvatar-colorDefault css-auhgt3">
                    <div id="image-preview" innerHTML={PersonIcon}></div>
        ...
        <div class="step-btn-wrapper">
          <button class="step-button" disabled={this.isLoading || this.isFormInvalid()} onClick={() => this.handleUserRoleClick()}>Next: Pick your Role</button>
        </div>
      </div>
    );
  }
